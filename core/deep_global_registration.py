...
class DeepGlobalRegistration:
    ...
    def preprocess(self, pcd):
        ...
        _coords, sel = ME.utils.sparse_quantize(
    ...
    def inlier_prediction(self, inlier_feats, coords):
        ...
        sinput = ME.SparseTensor(
            inlier_feats, coordinates=coords, device=self.device)
    ...
    def extract_feature(self, xyz0, xyz1):
        with torch.no_grad():
            ...
            return fcgf_feats0, fcgf_feats1, inlier_feats
